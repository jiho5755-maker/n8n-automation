...
- [x] n8n 워크플로우 JSON 생성 (n8n-workflow-builder 에이전트 활용)
- [x] Code 노드 JS 로직: KST 변환 + 72시간 계산
- [x] 메이크샵 Credential 연결 + 테스트 (2026-02-25, 텔레그램 수신 확인)
- [ ] 알림톡 template_code 연결 (`PRESSCO_CANCEL`) — 검수 완료 후 활성화
- [x] 서버 Import 완료 (ID: `8mvAqKsA1BUkPF3j`)
- [ ] 알림톡 활성화 + 실제 무통장 주문 1건으로 전체 플로우 확인
...
| 워크플로우 | 기능 | 상태 | 배포일 |
|-----------|------|------|--------|
| F010 미수금 관리 | 72시간 무통장 자동 취소 | ✅ 운영 중 (알림톡 비연결) | 2026-02-25 (ID: 8mvAqKsA1BUkPF3j) |
