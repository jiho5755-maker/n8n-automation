...
| 장바구니 조회 | GET | cart | Phase 2 (이탈 유도) **⚠️ API 존재 여부 미확인 — 메이크샵 고객센터 문의 필수** |
...
14. **장바구니 API 존재 여부 미확인** — 메이크샵 고객센터 문의 필수, F021 구현 가능성에 직접 영향
...
| 5 | 메이크샵 장바구니(cart) API 존재 여부 미확인 | 중 | 중 | **서버 배포 전 메이크샵 고객센터에 직접 문의 필수**. 미지원 시 F021(장바구니 이탈 유도) 대안 검토: 메이크샵 관리자 장바구니 알림 기능 활용 또는 기능 보류 |
